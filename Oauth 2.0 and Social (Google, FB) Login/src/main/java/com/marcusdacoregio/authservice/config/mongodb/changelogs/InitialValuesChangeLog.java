...
public class InitialValuesChangeLog {
    ...
    @ChangeSet(order = "001", id = "insertBrowserClientDetails", author = "")
    public void insertBrowserClientDetails(MongoTemplate mongoTemplate) {
        ...
        String authorities = Authorities.ROLE_USER.toString();
        ...
        browserClientDetails.setAuthorities(authorities);
    ...
    @ChangeSet(order = "002", id = "insertUserToTestAuthentication", author = "")
    ...
    @ChangeSet(order = "003", id = "insertAccountServiceClientDetails", author = "")
